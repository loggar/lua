...
RUN git config --global user.password "charly.loggar@gmail.com"
RUN set -ex \
...
```
docker run -t -d --name lua1 --rm -v C:/Users/webnl/Documents/_workspace/loggar-lua:/home/workspace-lua loggar/labs-lua:1.0
```
